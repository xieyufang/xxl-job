	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
                ...
                <li class="nav-click <#if pageName == "kettleInfo">active</#if>" ><a href="${request.contextPath}/kettleInfo"><i class="fa fa-circle-o text-aqua"></i><span>KETTLE管理</span></a></li>
                <li class="nav-click <#if pageName == "kettleLog">active</#if>" ><a href="${request.contextPath}/kettleLog"><i class="fa fa-circle-o text-green"></i><span>KETTLE日志</span></a></li>
				<li class="nav-click <#if pageName == "jobinfo">active</#if>" ><a href="${request.contextPath}/jobinfo"><i class="fa fa-circle-o text-red"></i><span>任务管理</span></a></li>
                ...
                <li class="nav-click <#if pageName == "jobgroup">active</#if>" ><a href="${request.contextPath}/jobgroup"><i class="fa fa-circle-o text-gray"></i><span>执行器管理</span></a></li>
			</ul>
		</section>
		<!-- /.sidebar -->
	</aside>
